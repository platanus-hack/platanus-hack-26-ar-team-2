  ...
  return (
    <div className="min-h-screen bg-[var(--page)] text-[var(--text)]">
        ...
        <div className="max-w-3xl mx-auto px-6 py-5 flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <h1 className="text-xl font-bold">Panel del Influencer</h1>
            </div>
          </div>
          <ThemeToggle />
        </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-6 flex flex-col gap-3">
        {[
          { href: "/dock?demo=1",          label: "Control en vivo",   desc: "Disparar avisos · saldo · historial" },
          { href: "/settings/preferences", label: "Preferencias",      desc: "Marcas aprobadas · palabras bloqueadas" },
          { href: "/settings/inventory",   label: "Inventario",        desc: "Zonas · precios mínimos · duración" },
